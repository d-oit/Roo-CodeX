...
import { type ProviderSettingsEntry, type ClineMessage, ORGANIZATION_ALLOW_ALL } from "@roo-code-x/types"
import { TelemetryService } from "@roo-code-x/telemetry"
...
describe("getTelemetryProperties", () => {
	...
	describe("cloud authentication telemetry", () => {
		...
		test("includes cloud authentication property when user is authenticated", async () => {
			...
			const { CloudService } = await import("@roo-code-x/cloud")
